...
class phoneBatteryIQView extends WatchUi.WatchFace {
	...
	function draw_vivoactiveHR(dc){
    	uiH.drawTopRight(dc,88,-5,14,6,false);
  		uiH.drawHours(dc,25,-32,40,0);
		uiH.drawMinutes(dc,70,60,50,0);
		dc.drawText(2,130, uiH.getSmallFont(),uiH.getHR(), Graphics.TEXT_JUSTIFY_LEFT);
    	dc.drawText(2,150, uiH.getSmallFont(),uiH.getBattery(), Graphics.TEXT_JUSTIFY_LEFT);
	}
